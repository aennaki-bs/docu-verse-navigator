...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      "dark:focus:bg-blue-900/30 dark:data-[state=open]:bg-blue-900/30",
      "light:focus:bg-blue-100 light:data-[state=open]:bg-blue-100",
      inset && "pl-8",
      className
    )}
    {...props}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ...
    className={cn(
      ...
      "dark:border-blue-900/50 dark:bg-[#0a1033] dark:text-blue-100",
      "light:border-blue-200 light:bg-white light:text-blue-950",
      className
    )}
    {...props}
  />
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      "dark:focus:bg-blue-900/30 dark:focus:text-blue-100",
      "light:focus:bg-blue-100 light:focus:text-blue-950",
      inset && "pl-8",
      className
    )}
    {...props}

      ...
      <div className="fixed bottom-0 left-0 right-0 bg-[#0a1033] border-t border-blue-900/50 shadow-lg p-4 flex items-center justify-between z-50">
        ...
        <div className="flex gap-3">
          <div className="flex items-center gap-2">
            <span className="text-blue-300">Change Role:</span>
            <Select value={selectedRole} onValueChange={handleRoleChange}>
              <SelectTrigger className="w-[120px] bg-blue-950/50 border-blue-900/50 text-white">
                <SelectValue placeholder="Select Role" />
              </SelectTrigger>
              <SelectContent className="bg-[#0a1033] border-blue-900/30 text-white">
                <SelectItem value="Admin" className="hover:bg-blue-900/20">
                  Admin
                </SelectItem>
                <SelectItem value="Manager" className="hover:bg-blue-900/20">
                  Manager
                </SelectItem>
                <SelectItem value="User" className="hover:bg-blue-900/20">
                  User
                </SelectItem>
              </SelectContent>
            </Select>
